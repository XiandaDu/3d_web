      ...
      <section className="max-container">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            ...
            focus on practical solutions and streamlined development, I
            specialize in creating efficient, effective solutions. Explore my
            skills and discover the craftsmanship behind every project. Let's
